...
_STRINGS = {
    ...
    'next_batch_prompt': {
        "en": "Want more? Tap below for the next {n} older posts.",
        "ru": "Нужно ещё? Нажмите ниже — следующие {n} постов постарше.",
        "uz": "Yana kerakmi? Quyidagini bosing — keyingi {n} ta eskiroq post.",
        "de": "Mehr? Tippe unten für die nächsten {n} älteren Posts.",
        "tr": "Daha fazlası? Sonraki {n} eski gönderi için aşağıya dokunun.",
    },
    'next_batch_btn': {
        "en": "📥 Next {n} (older)",
        "ru": "📥 Ещё {n} (старше)",
    ...
    'delivery_line_skipped_seen': {
        "en": "  ↩️ {n} already-seen skipped",
        "ru": "  ↩️ {n} уже просмотренных пропущено",
        "uz": "  ↩️ {n} ta ko'rilgan o'tkazib yuborildi",
        "de": "  ↩️ {n} bereits gesehene übersprungen",
        "tr": "  ↩️ {n} daha önce görülen atlandı",
    },
    'delivery_line_muted': {
        "en": "  🔇 {n} muted",
        "ru": "  🔇 {n} приглушено",
        "uz": "  🔇 {n} ta ovozsiz qilindi",
    ...
    'skipseen_status_on': {
        ...
        "ru": "Пропуск уже просмотренных ВКЛ. Обычный /scrape N не пришлёт уже полученные посты. Разово включить: `/scrape N all`.",
        "uz": "Ko'rilganlarni o'tkazish YOQ. Oddiy /scrape N olingan postlarni qayta yubormaydi. Bir martalik: `/scrape N all`.",
        "de": "Bereits-gesehen-überspringen AN. Ein einfaches /scrape N sendet erhaltene Posts nicht erneut. Einmalig: `/scrape N all`.",
        "tr": "Görülenleri atlama AÇIK. Düz /scrape N aldığın gönderileri tekrar göndermez. Tek seferlik: `/scrape N all`.",
    },
    'skipseen_status_off': {
        "en": "Skip already-seen is OFF. Every /scrape includes posts you've already received.",
        "ru": "Пропуск уже просмотренных ВЫКЛ. Каждый /scrape включает уже полученные посты.",
        "uz": "Ko'rilganlarni o'tkazish O'CHIQ. Har bir /scrape olingan postlarni ham qo'shadi.",
        "de": "Bereits-gesehen-überspringen AUS. Jedes /scrape enthält bereits erhaltene Posts.",
        "tr": "Görülenleri atlama KAPALI. Her /scrape aldığın gönderileri de içerir.",
    },
    'skipseen_set_on': {
        "en": "✅ Skip already-seen enabled. /scrape will only send new posts.",
        "ru": "✅ Пропуск уже просмотренных включён. /scrape будет присылать только новые посты.",
        "uz": "✅ Ko'rilganlarni o'tkazish yoqildi. /scrape faqat yangi postlarni yuboradi.",
        "de": "✅ Bereits-gesehen-überspringen aktiviert. /scrape sendet nur neue Posts.",
        "tr": "✅ Görülenleri atlama açıldı. /scrape yalnızca yeni gönderileri yollar.",
    },
    'skipseen_set_off': {
        "en": "✅ Skip already-seen disabled. /scrape will include all posts.",
        "ru": "✅ Пропуск уже просмотренных отключён. /scrape будет включать все посты.",
        "uz": "✅ Ko'rilganlarni o'tkazish o'chirildi. /scrape barcha postlarni qo'shadi.",
        "de": "✅ Bereits-gesehen-überspringen deaktiviert. /scrape enthält alle Posts.",
        "tr": "✅ Görülenleri atlama kapatıldı. /scrape tüm gönderileri içerir.",
    },
    'skipseen_usage': {
        "en": "Usage: /skipseen on | off",
        "ru": "Использование: /skipseen on | off",
        "uz": "Foydalanish: /skipseen on | off",
        "de": "Verwendung: /skipseen on | off",
        "tr": "Kullanım: /skipseen on | off",
    },
    'no_articles_skipped_seen': {
        "en": "({n} already-seen were skipped — use `/scrape N all` to include them.)",
        "ru": "({n} уже просмотренных пропущено — `/scrape N all` чтобы включить.)",
        "uz": "({n} ta ko'rilgan o'tkazib yuborildi — qo'shish uchun `/scrape N all`.)",
        "de": "({n} bereits gesehene übersprungen — `/scrape N all` zum Einschließen.)",
        "tr": "({n} daha önce görülen atlandı — dahil etmek için `/scrape N all`.)",
    },
    'no_articles_muted': {
        "en": "({n} muted by your filters — /mute to review.)",
        "ru": "({n} приглушено вашими фильтрами — /mute для просмотра.)",
        "uz": "({n} ta filtrlaringiz bilan ovozsiz qilindi — /mute ko'rish uchun.)",
        "de": "({n} durch deine Filter stummgeschaltet — /mute zum Prüfen.)",
        "tr": "({n} filtrelerinizce sessize alındı — /mute ile gözden geçirin.)",
    },

    # ---- mute / unmute ----
    'mute_currency_on': {
        "en": "🔇 Currency posts: MUTED (daily exchange-rate posts are hidden).",
        "ru": "🔇 Посты о курсе валют: ПРИГЛУШЕНЫ (ежедневные курсы скрыты).",
        "uz": "🔇 Valyuta postlari: OVOZSIZ (kunlik valyuta kurslari yashirilgan).",
        "de": "🔇 Währungsposts: STUMM (tägliche Wechselkurs-Posts ausgeblendet).",
        "tr": "🔇 Döviz gönderileri: SESSİZ (günlük kur gönderileri gizli).",
    },
    'mute_currency_off': {
        "en": "🔊 Currency posts: shown.",
        "ru": "🔊 Посты о курсе валют: показываются.",
        "uz": "🔊 Valyuta postlari: ko'rsatiladi.",
        "de": "🔊 Währungsposts: werden angezeigt.",
        "tr": "🔊 Döviz gönderileri: gösteriliyor.",
    },
    'mute_keywords_list': {
        "en": "Muted keywords: {list}",
        "ru": "Приглушённые слова: {list}",
        "uz": "Ovozsiz so'zlar: {list}",
        "de": "Stummgeschaltete Stichwörter: {list}",
        "tr": "Sessize alınan kelimeler: {list}",
    },
    'mute_keywords_none': {
        "en": "No muted keywords. Add one with /mute <keyword>.",
        "ru": "Нет приглушённых слов. Добавить: /mute <слово>.",
        "uz": "Ovozsiz so'zlar yo'q. Qo'shish: /mute <so'z>.",
        "de": "Keine stummgeschalteten Stichwörter. Hinzufügen: /mute <Wort>.",
        "tr": "Sessize alınan kelime yok. Ekle: /mute <kelime>.",
    },
    'mute_currency_set': {
        "en": "🔇 Currency posts are now muted. /unmute currency to undo.",
        "ru": "🔇 Посты о курсе валют приглушены. /unmute currency чтобы отменить.",
        "uz": "🔇 Valyuta postlari ovozsiz qilindi. Bekor qilish: /unmute currency.",
        "de": "🔇 Währungsposts sind jetzt stumm. Rückgängig: /unmute currency.",
        "tr": "🔇 Döviz gönderileri sessize alındı. Geri al: /unmute currency.",
    },
    'mute_keywords_added': {
        "en": "🔇 Muted: {list}. Posts containing these are now hidden.",
        "ru": "🔇 Приглушено: {list}. Посты с этими словами теперь скрыты.",
        "uz": "🔇 Ovozsiz: {list}. Bu so'zli postlar yashiriladi.",
        "de": "🔇 Stumm: {list}. Posts mit diesen Wörtern werden ausgeblendet.",
        "tr": "🔇 Sessize alındı: {list}. Bunları içeren gönderiler gizli.",
    },
    'unmute_usage': {
        "en": "Usage: /unmute currency | all | <keyword ...>",
        "ru": "Использование: /unmute currency | all | <слово ...>",
        "uz": "Foydalanish: /unmute currency | all | <so'z ...>",
        "de": "Verwendung: /unmute currency | all | <Wort ...>",
        "tr": "Kullanım: /unmute currency | all | <kelime ...>",
    },
    'unmute_currency_set': {
        "en": "🔊 Currency posts are no longer muted.",
        "ru": "🔊 Посты о курсе валют больше не приглушены.",
        "uz": "🔊 Valyuta postlari endi ovozsiz emas.",
        "de": "🔊 Währungsposts sind nicht mehr stumm.",
        "tr": "🔊 Döviz gönderileri artık sessiz değil.",
    },
    'unmute_all': {
        "en": "🔊 All mutes cleared (currency + keywords).",
        "ru": "🔊 Все приглушения сняты (курс валют + слова).",
        "uz": "🔊 Barcha ovozsizlar tozalandi (valyuta + so'zlar).",
        "de": "🔊 Alle Stummschaltungen entfernt (Währung + Stichwörter).",
        "tr": "🔊 Tüm sessize almalar temizlendi (döviz + kelimeler).",
    },
    'unmute_keywords_removed': {
        "en": "🔊 Unmuted: {list}.",
        "ru": "🔊 Сняты: {list}.",
        "uz": "🔊 Ovozsizdan chiqarildi: {list}.",
        "de": "🔊 Entstummt: {list}.",
        "tr": "🔊 Sessizden çıkarıldı: {list}.",
    },
